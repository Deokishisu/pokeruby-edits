...
const u8 * const gMonEggIconTable[] =
{
    gMonIcon_Egg,
    gMonIcon_Bulbasaur,
    gMonIcon_Egg,
...
const u8 *GetMonEggIconPtr(u16, u32 personality); //for unique egg icons
...
u8 CreateMonIcon(u16 species, void (*callback)(struct Sprite *), s16 x, s16 y, u8 subpriority, u32 personality)
{
    ...
    if (species > 60000) //for unique Egg Icons
    {
    	iconTemplate.image = GetMonEggIconPtr((species - 60000), personality);
    	iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[species - 60000];
    }
...
const u8 *GetMonEggIconPtr(u16 species, u32 personality) //for unique egg icons
{
    u16 convertedSpecies = mon_icon_convert_unown_species_id(species, personality);
    return gMonEggIconTable[convertedSpecies];
}
